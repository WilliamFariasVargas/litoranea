...
<section id="div_tipo_pessoa" class="row col-md-12">
    ...
    <div class="col-md-8 mt-12">
        ...
        <input type="text" maxlength="20" name="cpf_cnpj" id="cpf_cnpj" class="form-control" value="{{ $cliente->cpf_cnpj ?? '' }}" />
    </div>
</section>
...
<div class="row col-md-12">
    <div class="form-group col-md-6 mt-2">
        ...
        <input type="text" maxlength="250" name="razao_social" class="form-control" id="razao_social" value="{{ $cliente->razao_social ?? '' }}" />
    </div>
    <div class="col-md-6 form-group mt-2">
        <label id="labelFantasia">Nome Fantasia:</label>
        <input type="text" name="nome_fantasia" id="nome_fantasia" class="form-control" required value="{{ $cliente->nome_fantasia ?? '' }}">
    </div>
</div>
...
<div class="row col-md-12">
    <div class="col-md-4 form-group mt-2" id="div_inscricao_estadual" style="display: none;">
        ...
        <input type="text" maxlength="50" name="inscricao_estadual" id="inscricao_estadual" class="form-control" value="{{ $cliente->inscricao_estadual ?? '' }}">
    </div>
</div>
...
<div class="row col-md-12">
    <div class="col-md-4 form-group mt-2">
        ...
        <input type="tel" name="fone" id="fone" class="form-control" value="{{ $cliente->fone ?? '' }}">
    </div>
    <div class="col-md-4 form-group mt-2">
        <label>Telefone 2:</label>
        <input type="tel" name="fone_2" id="fone_2" class="form-control" value="{{ $cliente->fone_2 ?? '' }}">
    </div>
    <div class="col-md-4 form-group mt-2">
        <label>Telefone 3:</label>
        <input type="tel" name="fone_3" id="fone_3" class="form-control" value="{{ $cliente->fone_3 ?? '' }}">
    </div>
</div>
...
<div class="row col-md-12">
    <div class="col-md-4 form-group mt-2">
        <label>Celular:</label>
        <input type="tel" name="celular" id="celular" class="form-control" value="{{ $cliente->celular ?? '' }}">
    </div>
    <div class="col-md-4 form-group mt-2">
        <label>Celular 2:</label>
        <input type="tel" name="celular_2" id="celular_2" class="form-control" value="{{ $cliente->celular_2 ?? '' }}">
    </div>
    <div class="col-md-4 form-group mt-2">
        <label>Celular 3:</label>
        <input type="tel" name="celular_3" id="celular_3" class="form-control" value="{{ $cliente->celular_3 ?? '' }}">
    </div>
</div>
...
<div class="row col-md-12">
    <div class="col-md-4 form-group mt-2">
        ...
        <input type="text" name="responsavel" id="responsavel" class="form-control" value="{{ $cliente->responsavel ?? '' }}">
    </div>
    <div class="col-md-4 form-group mt-2">
        <label>E-mail:</label>
    ...
    <div class="col-md-4 form-group mt-2">
        ...
        <input type="email" name="email_2" id="email_2" class="form-control" value="{{ $cliente->email_2 ?? '' }}">
    </div>
</div>
...
<div class="row col-md-12">
    <div class="col-md-4 form-group mt-2">
        ...
        <input type="email" name="email_3" id="email_3" class="form-control" value="{{ $cliente->email_3 ?? '' }}">
    </div>
    <div class="col-md-4 form-group mt-2">
        <label>E-mail 4:</label>
        <input type="email" name="email_4" id="email_4" class="form-control" value="{{ $cliente->email_4 ?? '' }}">
    </div>
    <div class="col-md-4 form-group mt-2">
        <label>E-mail NFe:</label>
        <input type="email" name="email_nfe" id="email_nfe" class="form-control" value="{{ $cliente->email_nfe ?? '' }}">
    </div>
</div>
    ...
    <div class="col-md-3 form-group mt-2">
        ...
        <select class="form-control select2" name="uf" id="uf">
            ...
            @foreach(['AC','AL','AP','AM','BA','CE','DF','ES','GO','MA','MT','MS','MG','PA','PB','PR','PE','PI','RJ','RN','RS','RO','RR','SC','SP','SE','TO'] as $estado)
                <option value="{{ $estado }}" {{ ($cliente && $cliente->uf == $estado) ? 'selected' : '' }}>{{ $estado }}</option>
            @endforeach
        </select>
    </div>
</div>
...
<div class="col-md-12 form-group mt-4">
    ...
    <textarea name="observacoes" id="observacoes" rows="3" class="form-control">{{ $cliente->observacoes ?? '' }}</textarea>
</div>
    ...
    $(document).ready(function () {
        ...
        $("#create_edit").submit(function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    let msg = xhr.responseJSON?.message || 'Erro ao salvar dados';
