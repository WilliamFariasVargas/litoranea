    ...
    <div class="row">
        ...
        <div class="col-md-8 form-group mb-2">
            ...
            <select name="cliente_id" id="cliente_id" class="form-control select2" required>
                <option value="{{ $pedido->cliente_id }}" selected>{{ $pedido->cliente->razao_social ?? 'Selecionado' }}</option>
            </select>
        </div>
        ...
        <div class="col-md-6 form-group mb-2">
            ...
            <select name="representada_id" id="representada_id" class="form-control select2" required>
                <option value="{{ $pedido->representada_id }}" selected>{{ $pedido->representada->nome ?? 'Selecionado' }}</option>
            </select>
        </div>
        ...
        <div class="col-md-6 form-group mb-2">
            ...
            <select name="transportadora_id" id="transportadora_id" class="form-control select2">
                @if($pedido->transportadora_id)
                    <option value="{{ $pedido->transportadora_id }}" selected>{{ $pedido->transportadora->nome ?? 'Selecionado' }}</option>
                @endif
            </select>
        </div>
        ...
        <div class="col-md-4 form-group mb-2">
            ...
            <input type="date" name="data_faturamento" class="form-control" value="{{ $pedido->data_faturamento }}">
        </div>
...
$(document).ready(function() {
    var url_post = "{{ route('cadastrodepedido.update', $pedido->id) }}";
